export const projects = [
    {
        "title": "Interviewy",
        "summary": "Interviewy provides jobseekers an accessible environment where they can practice their interview skills at any time.",
        "description": `<p>
        ...
        "otherLinks": [],
        "video": {path: "assets/videos/interviewy.mov", width:"640", height: "320"},
        "highlight": true
    },
    {
        "title": "STDetector",
        "summary": "STDetector is a social media esque platform that decreases the stigma of sharing STI test results with sexual partners.",
        "description": `<p>
        ...
        "otherLinks": [{link:"https://devpost.com/software/stdetector", name: "Devpost"}],
        "video": {path: "assets/videos/stdetector.mp4", width: "600", height: "400"},
        "highlight": true
    },
    {
        "title": "#ClimateChange",
        "summary": "#ClimateChange uses Twitter data to create a visualization of the distribution of tweets surrounding climate change in the United States over time.",
        "description": `<p>
        ...
        "otherLinks": [],
        "video": {path: "assets/videos/climate-change.mov", width:"640", height: "320"},
        "highlight": false
    },
    {
        "title": "Slow Fashion",
        "summary": "A website promoting sustainable fashion practices and brands, created for the SheHacks 2021 hackathon.",
        ...
        "otherLinks": [{link: "https://faizahsayyid.github.io/shehacks-submission/FINAL%20WEBSITE%202/FINAL%20WEBSITE/main.html", name: "See Website"}],
        "video": {path: "assets/videos/slow-fashion.mov", width:"720", height: "355"},
        "highlight": false
    },
    {
        "title": "Slime Climb",
        "summary": "A 2D platformer game made during the University of Toronto Game Design and Development Club (UTGDDC) Fall 2020 Game Jam.",
        ...
        "video": {path: "assets/videos/slime-climb.mov", width: "760", height: "474"},
        "highlight": true
    }
]